...
public interface UsuarioRepository extends CrudRepository <UsuarioModel, Integer> { // Classe que possui métodos pré-programados com as principais funcionalidades
